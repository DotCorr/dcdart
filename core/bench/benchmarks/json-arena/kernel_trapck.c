 ...
 *
 * TRAP-MATCHED variant, generated from THIS directory's own kernel.c and not
 * copied from a sibling -- copying one produced a baseline comparing an arena
 * against malloc and reporting the difference as the cost of arithmetic.
 *
